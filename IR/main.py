# 写一个debugger ?
# 同样可以考虑 unit test + package + coverage
...
class ToIR(Transformer):
    ...
    def and_(self, _): return RelOp.And
    def or_(self, _): return RelOp.Or
...
parser = Lark.open("grammar.lark", parser="earley", rel_to=__file__)
...
if __name__ == "__main__":
    arg_parser = argparse.ArgumentParser(
        description="Interpret a given file generated by your compiler.")
